...
using infrastructure.repository.product.read;
using infrastructure.repository.product.write;
...
namespace crosscutting.DI
{
    public static class ServiceCollection
    {
        ...
        {
            // Assembly é o .dll do projeto
            var assembly = Assembly.Load("AvaStock.Application");
